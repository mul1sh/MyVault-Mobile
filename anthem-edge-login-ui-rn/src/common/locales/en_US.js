...
const strings = {
  ...
  terms_one:
    'I understand that my funds are held securely on this device, not by Hercules',
  terms_two:
  ...
  terms_three:
    'I understand that if I lose my username and password, Hercules will not be able to recover my account, unless I setup password recovery',
  ...
  otp_email_body:
    'Please click the link below from a mobile device with Hercules installed to initiate account recovery for username ',
  otp_email_subject: 'Hercules Recovery Token',
  recovery_disabled:
  ...
  welcome_one:
    "Let's get started by creating your account login. You’ll choose a username and password, which we’ll use to encrypt your account. Not even Hercules has access to your information, so you have full and complete control over your digital assets.",
  ...
  username_desc:
    'Your username will be required to sign in to your Hercules account on this and other devices.',
